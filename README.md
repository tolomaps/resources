...
- [GADM](http://gadm.org/ Global Administrative Areas): <span style="color: #3b3b3b;">GADM is a spatial database of the location of the world's administrative areas (or administrative boundaries). Includes countries as well as lower level administrative boundaries.</span>
